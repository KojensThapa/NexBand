...
export function SampleReportsIcon({ className }: IconProps) {
  return (
    <svg className={cn("h-5 w-5", className)} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
...
export function LessonsIcon({ className }: IconProps) {
  return (
    <svg className={cn("h-5 w-5", className)} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A16.991 16.991 0 0112 21.75c2.305 0 4.408-.867 6-2.292m0-14.25a16.991 16.991 0 0112 21.75c-2.305 0-4.408-.867-6-2.292m0-14.25v14.25" />
    </svg>
  );
}
