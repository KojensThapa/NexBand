...
export function VerifyEmailForm({ email }: VerifyEmailFormProps) {
  ...
  async function handleVerify(event: React.FormEvent) {
    ...
    try {
      ...
      toast.success("Email verified. Welcome to NexBand!");
  ...
  return (
    <form onSubmit={handleVerify} className="space-y-6">
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-2 text-center text-sm font-medium text-indigo-600 hover:text-indigo-500 disabled:cursor-not-allowed disabled:text-slate-400"
      >
        {isResending ? (
          <>
